...
const PROCESSED_TAG = 'ev_cancel_processed';
const TARGET_SUBJECT = 'Customer cancelled subscription';
const MACRO_ID = process.env.MACRO_ID || '32523842414871'; // CANCELLATION MACRO - NOT THE WELCOME MACRO!
...
async function processTicket(ticketId) {
  try {
    ...
    console.error(`Error processing cancellation ticket ${ticketId}:`, error.message, error.response?.data);
